...
def download_article_and_images():
    url = "https://info.rsuquant.ru/article/10143"
    ...
    try:
        ...
        with open('raw_zator_page.html', 'w', encoding='utf-8') as f:
            f.write(response.text)
        print("Saved raw HTML to raw_zator_page.html")
